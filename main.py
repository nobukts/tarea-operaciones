...
def read_srflp(file_name):
    """
    Función para el análisis y lectura de la instancia SRFLP.
    :param file_name: Nombre del archivo de la instancia.
...
def print_instance(n, f_size, f_weight):
    ...
    :param n: Número de instalaciones.
    :param f_size: Tamaños de las instalaciones.
    :param f_weight: Matriz de pesos.
    """
...
def get_weight(f_weight, i, j):
    ...
    :param f_weight: Matriz de pesos.
    :param i: Índice de la instalación i.
    :param j: Índice de la instalación j.
...
def total_distance(n, f_size, f_weight, sol):
    ...
    :param f_size: Tamaños de las instalaciones.
    :param f_weight: Matriz de pesos.
    :param sol: Arreglo con el orden de las instalaciones.
...
distancia_total = total_distance(n, f_size, f_weight, solucion)
print("Distancia total recorrida por los clientes:", distancia_total)